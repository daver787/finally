...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/personal/Desktop/projects/finally/.claude/.gsd-surface.json`
(sibling to `/Users/personal/Desktop/projects/finally/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/personal/Desktop/projects/finally/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/Users/personal/Desktop/projects/finally/.claude/skills`).
...
`/Users/personal/Desktop/projects/finally/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/Users/personal/Desktop/projects/finally/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/personal/Desktop/projects/finally/.claude/.gsd-surface.json`
Install profile marker: `/Users/personal/Desktop/projects/finally/.claude/.gsd-profile`
Skill dirs: `/Users/personal/Desktop/projects/finally/.claude/skills/gsd-*/`
Engine module: `/Users/personal/Desktop/projects/finally/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/Users/personal/Desktop/projects/finally/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
