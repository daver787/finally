...
```
Agent(
  prompt="Read /Users/personal/Desktop/projects/finally/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/personal/Desktop/projects/finally/.claude/get-shit-done/templates/VALIDATION.md`
