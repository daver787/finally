...
```bash
INIT=$(node "/Users/personal/Desktop/projects/finally/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/personal/Desktop/projects/finally/.claude/get-shit-done/templates/spec.md.
