...
```bash
INIT=$(node "/Users/personal/Desktop/projects/finally/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/personal/Desktop/projects/finally/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
