...
INSTALL_JS_GLOBAL="/Users/personal/Desktop/projects/finally/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/personal/Desktop/projects/finally/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
